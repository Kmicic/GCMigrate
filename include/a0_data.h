...
// #include <Arduino.h>
// Remove this include from the header file to avoid deep nesting.
// If needed, include <Arduino.h> only in your main .cpp file.
...
// #include "a1_data.h"
// If a1_data.h includes a0_data.h or causes deep nesting, remove this include.
// Include only where absolutely necessary in .cpp files.
// температурный коэффициент термистора 4 (см. даташит)
...
extern byte curPWMchannel; // текущий канал ШИМ
extern byte curSetMode;   // текущий режим настроек
